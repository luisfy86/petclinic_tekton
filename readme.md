#DEBEMOS ADAPTAR LA DOCUMENTACION DEL PROYECTO PILOTO helm - test
...
| Layer | Source |
|--|--|
| REST API controllers | [REST folder](src/main/java/com/minsait/bm/petclinic/rest) |
| Service | [ClinicServiceImpl.java](src/main/java/com/minsait/bm/petclinic/service/ClinicServiceImpl.java) |
| JDBC | [jdbc folder](src/main/java/com/minsait/bm/petclinic/repository/jdbc) |
| JPA | [jpa folder](src/main/java/com/minsait/bm/petclinic/repository/jpa) |
| Spring Data JPA | [springdatajpa folder](src/main/java/com/minsait/bm/petclinic/repository/springdatajpa) |
